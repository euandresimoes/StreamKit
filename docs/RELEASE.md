...
3. Executar `pnpm validate` e `pnpm --filter @streamlet/desktop package:win` no Windows.
4. Executar `pnpm --filter @streamlet/desktop smoke:artifact`.
