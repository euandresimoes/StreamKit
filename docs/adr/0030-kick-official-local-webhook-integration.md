...
da Kick a cada reinicialização do Streamlet. O callback OAuth continua local e separado do webhook.
...
- A URL do webhook é temporária e muda quando o Streamlet reinicia; isso é uma limitação assumida
...
- O Streamlet deverá renovar o token e recriar a subscription quando a URL do túnel mudar.
